...
router.post('/create',  async(req,res) => {
 ...
 console.log('signinUser==',signinUser);
  console.log('signinUser.userPassword==',signinUser.userPassword);
 
	
if(signinUser) 
{
	if(signinUser.userPassword ==undefined)
	{
     return res.send({ message: 'GoogleLogin'});
	}
	if(signinUser.userPassword !=undefined)
	{
...
if(req.body.googleId)
{
		...
		if(signinUser ==null)
		{
			const user = new User({	
					userEmail : req.body.email,
					userName : req.body.name ? req.body.name : 'Google Login'
				});
			...
			if (newUser) {
				...
				//console.log('email_not_registered==',email_not_registered)
